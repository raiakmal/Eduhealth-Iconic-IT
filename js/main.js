...
cariSekarangButton.addEventListener('click', function() {
  ...
  function getOrganDescription(system, organ) {
    ...
    'sistem-endokrin': {
        'kelenjar-hipofisis': "Kelenjar hipofisis adalah 'master gland' yang mengontrol kelenjar endokrin lainnya dan memproduksi berbagai hormon penting. Terletak di dasar otak, kelenjar ini mengeluarkan hormon yang mengatur pertumbuhan, metabolisme, fungsi reproduksi, dan keseimbangan air dalam tubuh. Kelenjar hipofisis memiliki dua lobus, yaitu lobus anterior yang menghasilkan hormon seperti hormon pertumbuhan (GH) dan prolaktin, serta lobus posterior yang menyimpan dan melepaskan hormon seperti oksitosin dan vasopresin.",
        'kelenjar-tiroid': "Kelenjar tiroid menghasilkan hormon yang mengatur metabolisme, pertumbuhan, dan perkembangan tubuh. Hormon tiroid, terutama tiroksin (T4) dan triiodotironin (T3), berperan penting dalam mengontrol seberapa cepat tubuh membakar kalori, menjaga suhu tubuh, serta mengatur detak jantung. Kelenjar tiroid terletak di leher, di bawah jakun, dan memiliki bentuk seperti kupu-kupu. Gangguan pada kelenjar tiroid, seperti hipotiroidisme atau hipertiroidisme, dapat berdampak signifikan pada kesehatan secara keseluruhan.",
        'kelenjar-paratiroid': "Kelenjar paratiroid mengatur kadar kalsium dalam darah dan tulang melalui produksi hormon paratiroid (PTH). Kalsium adalah mineral penting yang berperan dalam kontraksi otot, pembekuan darah, dan fungsi saraf. Kelenjar ini terletak di belakang kelenjar tiroid dan biasanya berjumlah empat. Ketidakseimbangan hormon paratiroid dapat menyebabkan kondisi seperti hiperkalsemia (kadar kalsium tinggi dalam darah) atau hipokalsemia (kadar kalsium rendah), yang masing-masing dapat mempengaruhi berbagai fungsi tubuh.",
        'kelenjar-adrenal': "Kelenjar adrenal menghasilkan hormon yang membantu tubuh merespons stres dan mengatur metabolisme. Terletak di atas ginjal, kelenjar adrenal terdiri dari dua bagian: korteks adrenal yang memproduksi hormon seperti kortisol dan aldosteron, dan medula adrenal yang memproduksi adrenalin dan noradrenalin. Hormon-hormon ini berperan dalam respon 'fight or flight', mengatur tekanan darah, metabolisme gula, serta keseimbangan garam dan air dalam tubuh.",
        'pankreas': "Pankreas memiliki fungsi ganda sebagai bagian dari sistem endokrin dan pencernaan. Sebagai kelenjar endokrin, pankreas menghasilkan hormon insulin dan glukagon yang mengatur kadar gula darah. Insulin menurunkan kadar gula darah dengan membantu sel-sel tubuh menyerap glukosa, sementara glukagon meningkatkan kadar gula darah dengan merangsang hati untuk melepaskan glukosa yang disimpan. Ketidakseimbangan produksi hormon ini dapat menyebabkan kondisi seperti diabetes mellitus.",
        'gonad': "Gonad, yaitu testis pada pria dan ovarium pada wanita, adalah kelenjar kelamin yang menghasilkan hormon seks dan sel-sel reproduksi. Pada pria, testis menghasilkan hormon testosteron yang penting untuk perkembangan karakteristik seksual pria dan produksi sperma. Pada wanita, ovarium menghasilkan hormon estrogen dan progesteron yang mengatur siklus menstruasi dan mendukung kehamilan. Fungsi gonad sangat penting untuk reproduksi dan perkembangan seksual.",
        'kelenjar-pineal': "Kelenjar pineal menghasilkan hormon melatonin yang mengatur siklus tidur dan bangun tubuh. Melatonin diproduksi dalam jumlah yang lebih tinggi saat malam hari, membantu tubuh untuk merasa mengantuk dan bersiap tidur. Kelenjar pineal terletak di dalam otak, tepat di tengah-tengah antara kedua belahan otak. Gangguan pada produksi melatonin dapat menyebabkan masalah tidur seperti insomnia atau gangguan tidur lainnya.",
        'kelenjar-timus': "Kelenjar timus berperan dalam perkembangan sistem kekebalan tubuh, terutama dalam produksi sel T, yang merupakan jenis sel darah putih yang penting dalam melawan infeksi. Kelenjar ini paling aktif selama masa kanak-kanak dan remaja, dan mulai menyusut setelah pubertas. Sel T yang diproduksi di timus berperan dalam mengenali dan menghancurkan sel-sel yang terinfeksi virus atau sel kanker, menjadikan timus penting untuk imunitas adaptif."
    },
    'sistem-pencernaan': {
        'mulut': "Mulut adalah tempat awal dari sistem pencernaan, di mana makanan dipecah secara mekanis oleh gigi dan secara kimiawi oleh air liur. Gigi berfungsi untuk menggiling dan menghaluskan makanan, sementara air liur yang mengandung enzim amilase mulai memecah karbohidrat. Proses ini menciptakan bolus, yaitu massa makanan yang lebih mudah dicerna ketika melewati saluran pencernaan selanjutnya. Selain itu, lidah membantu mengaduk makanan dan mendorongnya ke belakang menuju kerongkongan.",
        'kerongkongan': "Kerongkongan adalah tabung otot yang menghubungkan mulut dengan lambung, menggerakkan makanan melalui gerakan peristaltik. Peristaltik adalah kontraksi otot yang berirama yang mendorong bolus makanan turun ke lambung. Di ujung bawah kerongkongan, terdapat sfingter esofagus bawah yang mencegah makanan dan asam lambung naik kembali ke kerongkongan, yang bisa menyebabkan kondisi seperti refluks asam. Kerongkongan memainkan peran penting dalam memastikan makanan mencapai lambung untuk dicerna lebih lanjut.",
        'lambung': "Lambung adalah organ yang mencerna makanan secara mekanis dan kimiawi dengan bantuan asam lambung dan enzim. Ketika makanan masuk ke lambung, asam klorida dan enzim pepsin mulai memecah protein menjadi molekul yang lebih kecil, sementara kontraksi otot lambung membantu mencampur makanan dengan cairan pencernaan. Lambung juga bertindak sebagai penyimpanan sementara makanan sebelum diteruskan ke usus halus untuk penyerapan lebih lanjut. Selain pencernaan, lambung juga membantu membunuh patogen yang masuk bersama makanan melalui keasaman tinggi yang dihasilkan.",
        'usus-halus': "Usus halus adalah tempat utama penyerapan nutrisi dari makanan yang telah dicerna. Setelah makanan diproses di lambung, nutrisi penting seperti vitamin, mineral, karbohidrat, protein, dan lemak diserap melalui dinding usus halus yang sangat berlipat dan ditutupi dengan vili mikroskopis. Vili ini meningkatkan luas permukaan usus, memungkinkan penyerapan maksimal nutrisi ke dalam aliran darah. Usus halus terbagi menjadi tiga bagian: duodenum, jejunum, dan ileum, masing-masing dengan peran spesifik dalam pencernaan dan penyerapan.",
        'usus-besar': "Usus besar berfungsi menyerap air dan garam dari sisa makanan yang tidak dapat dicerna dan membentuk tinja. Setelah penyerapan nutrisi di usus halus, sisa-sisa yang tidak dicerna dialirkan ke usus besar di mana air dan elektrolit diserap untuk menjaga keseimbangan cairan tubuh. Usus besar juga berperan dalam fermentasi bahan makanan yang tidak tercerna oleh bakteri usus, yang menghasilkan gas dan beberapa vitamin yang diserap tubuh. Bagian akhir dari usus besar, rektum, berfungsi sebagai tempat penyimpanan sementara tinja sebelum dikeluarkan melalui anus.",
        ...
        'kantong-empedu': "Kantong empedu adalah organ kecil yang berfungsi menyimpan dan melepaskan empedu yang diproduksi oleh hati. Empedu sangat penting untuk mencerna lemak dalam makanan; ketika makanan berlemak masuk ke usus halus, kantong empedu berkontraksi untuk melepaskan empedu melalui saluran empedu ke usus. Empedu membantu mengemulsi lemak, memecahnya menjadi tetesan kecil yang dapat dicerna oleh enzim lipase. Masalah pada kantong empedu, seperti batu empedu, dapat mengganggu pencernaan dan menyebabkan rasa sakit yang signifikan.",
        'rektum': "Rektum adalah bagian akhir dari usus besar yang menyimpan tinja sebelum dikeluarkan dari tubuh. Setelah usus besar menyerap air dari sisa makanan, sisa tersebut berubah menjadi tinja yang dikumpulkan di rektum. Ketika rektum penuh, sinyal saraf dikirim ke otak yang memberi tahu tubuh untuk buang air besar. Rektum juga memiliki otot sfingter yang mengontrol pengeluaran tinja, memungkinkan proses pengeluaran yang teratur dan terkendali.",
    ...
    'sistem-pernapasan': {
        ...
        'bronkus': "Bronkus adalah cabang dari trakea yang membawa udara masuk dan keluar dari paru-paru. Setiap bronkus utama bercabang menjadi bronkus yang lebih kecil di dalam paru-paru, membentuk pohon bronkial yang mengarahkan udara ke alveoli, di mana pertukaran gas terjadi. Bronkus juga dilapisi dengan lapisan lendir dan silia yang berfungsi untuk menangkap dan mengeluarkan partikel asing dari saluran pernapasan. Kontraksi dan relaksasi otot-otot di dinding bronkus mengatur aliran udara, yang bisa dipengaruhi oleh kondisi seperti asma.",
        'paru-paru': "Paru-paru adalah organ utama pernapasan yang melakukan pertukaran oksigen dan karbon dioksida dengan darah. Paru-paru terdiri dari jutaan alveoli, kantung udara kecil yang dikelilingi oleh kapiler darah. Ketika kita menghirup udara, oksigen masuk ke alveoli dan berpindah ke dalam darah, sementara karbon dioksida dari darah dipindahkan ke alveoli untuk dikeluarkan saat kita menghembuskan napas. Paru-paru juga berperan dalam mengatur keseimbangan pH darah dengan mengontrol kadar karbon dioksida melalui proses pernapasan.",
